...
{
    public partial class CompanyImage : Form
    {
        CompanyImageWorker worker = new CompanyImageWorker();
        ...
        private void CompanyImage_Load(object sender, EventArgs e)
        {
        ...
        //程序退出
        private void CompanyImage_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (!worker.IsExit)
            {
        ...
        private void BtnStart_Click(object sender, EventArgs e)
        {
            if (TxtSavePath.Text != null && !string.IsNullOrEmpty(TxtSavePath.Text))
            {
                ...
                worker.companyId = txtCompanyId.Text.ToInt32();//传递指定产品ID
